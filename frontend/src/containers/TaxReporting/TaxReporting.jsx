          ...
          {(currentTaxYearDonations.length > 0 || previousTaxYearDonations.length > 0) ? (
            <>
              {currentTaxYearDonations.length > 0 ? (
                <div className={styles.section}>
                  ...
                  <div className={styles.downloadContainer}>
                    <button
                      ...
                      onClick={() =>
                        generatePdf(currentTaxYearDonations, currentLabel)
                      }
                    >
                      Download PDF
                    </button>
                ...
                <div className={styles.section}>
                  <h3>Current Financial Year ({currentLabel})</h3>
                  <p className={styles.noCurrentDonations}>
                    No donations were made in the current financial year.
                  </p>
                </div>
              )}
              ...
              {previousTaxYearDonations.length > 0 ? (
                ...
                <div className={styles.previousTaxYear}>
                  <h3>Previous Financial Year ({previousLabel})</h3>
                  <p className={styles.noPreviousDonations}>
                    No donations were made in the previous financial year.
                  </p>
                </div>
              )}
            </>
          ) : (
            <p className={styles.noDonations}>
              No donations have ever been made.
            </p>
          )}
        </>
      )}
